package builderdesignpatternInner;

import java.time.LocalDate;

import builderdesignpattern.Address;
...
public class Client {
	 ...
	 */
	private static UserDTO directBuild(builderdesignpatternInner.UserDTO.UserDTOBuilder userDTOBuilder, User user) {
